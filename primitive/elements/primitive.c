...
static int32_t decodePrimitive(jetName* result, bitstream* stream) {
  ...
  if (!bit) {
    ...
    switch (code) {
     ...
     case 0x10: return either(result, CURRENT_IS_PEGIN, CURRENT_PREV_OUTPOINT, stream);
     case 0x11: *result = CURRENT_ASSET; return 0;
     case 0x12: *result = CURRENT_AMOUNT; return 0;
     ...
     case 0x16: *result = CURRENT_ISSUANCE_ENTROPY; return 0;
     case 0x17: *result = CURRENT_ISSUANCE_ASSET_AMT; return 0;
     case 0x18: return either(result, CURRENT_ISSUANCE_TOKEN_AMT, TAPLEAF_VERSION, stream);
     case 0x19: *result = TAPBRANCH; return 0;
     case 0x1a: *result = INTERNAL_KEY; return 0;
