...
Definition _secp256k1_i128_check_bit : ident := $"secp256k1_i128_check_bit".
...
Definition _secp256k1_mulh : ident := $"secp256k1_mulh".
...
Definition _secp256k1_umulh : ident := $"secp256k1_umulh".
...
Definition f_secp256k1_umulh := {|
  fn_return := tulong;
  fn_callconv := cc_default;
  fn_params := ((_a, tulong) :: (_b, tulong) :: nil);
  fn_vars := nil;
  fn_temps := ((_t1, tulong) :: (_t2, tulong) :: (_t3, tulong) :: nil);
  fn_body :=
(Ssequence
  (Sset _t1
      ...
      (Sset _t3
        (Ebinop Oadd
          (Ebinop Oadd
            ...
            (Ebinop Oshr (Etempvar _t1 tulong)
              (Econst_int (Int.repr 32) tint) tulong) tulong)
          (Ecast (Etempvar _t2 tulong) tuint) tulong))
      (Sreturn (Some (Ebinop Oadd
                       (Ebinop Oadd
                         (Ebinop Omul
                           (Ebinop Oshr (Etempvar _a tulong)
                             (Econst_int (Int.repr 32) tint) tulong)
                           (Ebinop Oshr (Etempvar _b tulong)
                             (Econst_int (Int.repr 32) tint) tulong) tulong)
                         (Ebinop Oshr (Etempvar _t2 tulong)
                           (Econst_int (Int.repr 32) tint) tulong) tulong)
                       (Ebinop Oshr (Etempvar _t3 tulong)
                         (Econst_int (Int.repr 32) tint) tulong) tulong))))))
|}.

Definition f_secp256k1_mulh := {|
  fn_return := tlong;
  fn_callconv := cc_default;
  fn_params := ((_a, tlong) :: (_b, tlong) :: nil);
  fn_vars := nil;
  fn_temps := ((_t1, tulong) :: (_t2, tlong) :: (_t3, tlong) ::
               (_t4, tulong) :: nil);
  fn_body :=
(Ssequence
  (Sset _t1
        ...
        (Sset _t4
          (Ebinop Oadd
            (Ebinop Oadd
              (Ebinop Oshr (Etempvar _t1 tulong)
                (Econst_int (Int.repr 32) tint) tulong)
              (Ecast (Etempvar _t2 tlong) tuint) tulong)
            (Ecast (Etempvar _t3 tlong) tuint) tulong))
        (Sreturn (Some (Ebinop Oadd
                         (Ebinop Oadd
                           (Ebinop Oadd
                             (Ebinop Omul
                               (Ebinop Oshr (Etempvar _a tlong)
                                 (Econst_int (Int.repr 32) tint) tlong)
                               (Ebinop Oshr (Etempvar _b tlong)
                                 (Econst_int (Int.repr 32) tint) tlong)
                               tlong)
                             (Ebinop Oshr (Etempvar _t2 tlong)
                               (Econst_int (Int.repr 32) tint) tlong) tlong)
                           (Ebinop Oshr (Etempvar _t3 tlong)
                             (Econst_int (Int.repr 32) tint) tlong) tlong)
                         (Ecast
                           (Ebinop Oshr (Etempvar _t4 tulong)
                             (Econst_int (Int.repr 32) tint) tulong) tlong)
                         tlong)))))))
|}.
...
(Ssequence
  (Ssequence
    (Scall (Some _t'1)
      (Evar _secp256k1_umulh (Tfunction (Tcons tulong (Tcons tulong Tnil))
                               tulong cc_default))
      ((Etempvar _a tulong) :: (Etempvar _b tulong) :: nil))
    (Sassign
      (Efield
...
Definition f_secp256k1_u128_accum_mul := {|
  ...
  fn_params := ((_r, (tptr (Tstruct _secp256k1_uint128 noattr))) ::
                (_a, tulong) :: (_b, tulong) :: nil);
  fn_vars := nil;
  fn_temps := ((_lo, tulong) :: (_t'1, tulong) :: (_t'4, tulong) ::
               (_t'3, tulong) :: (_t'2, tulong) :: nil);
  fn_body :=
(Ssequence
  (Sset _lo (Ebinop Omul (Etempvar _a tulong) (Etempvar _b tulong) tulong))
  (Ssequence
    (Ssequence
      (Scall (Some _t'1)
        (Evar _secp256k1_umulh (Tfunction (Tcons tulong (Tcons tulong Tnil))
          ...
          (Sassign
            ...
            (Ebinop Oadd (Etempvar _t'3 tulong)
              (Ebinop Oadd (Etempvar _t'1 tulong)
                (Ebinop Olt (Eunop Onotint (Etempvar _lo tulong) tulong)
                  (Etempvar _t'4 tulong) tint) tulong) tulong)))))
    (Ssequence
      (Sset _t'2
        (Efield
          (Ederef (Etempvar _r (tptr (Tstruct _secp256k1_uint128 noattr)))
      ...
      (Sassign
        (Efield
          (Ederef (Etempvar _r (tptr (Tstruct _secp256k1_uint128 noattr)))
            (Tstruct _secp256k1_uint128 noattr)) _lo tulong)
        (Ebinop Oadd (Etempvar _t'2 tulong) (Etempvar _lo tulong) tulong)))))
|}.
    ...
    (Ssequence
      ...
      (Sassign
        ...
        (Ebinop Oadd (Etempvar _t'2 tulong)
          (Ebinop Ogt (Etempvar _t'3 tulong)
            (Eunop Onotint (Etempvar _a tulong) tulong) tint) tulong))))
  (Ssequence
    (Sset _t'1
      (Efield
        (Ederef (Etempvar _r (tptr (Tstruct _secp256k1_uint128 noattr)))
    ...
    (Sassign
      (Efield
        (Ederef (Etempvar _r (tptr (Tstruct _secp256k1_uint128 noattr)))
          (Tstruct _secp256k1_uint128 noattr)) _lo tulong)
      (Ebinop Oadd (Etempvar _t'1 tulong) (Etempvar _a tulong) tulong))))
|}.
...
(Ssequence
  (Ssequence
    (Scall (Some _t'1)
      (Evar _secp256k1_mulh (Tfunction (Tcons tlong (Tcons tlong Tnil)) tlong
                              cc_default))
      ((Etempvar _a tlong) :: (Etempvar _b tlong) :: nil))
    (Sassign
      (Efield
        (Ederef (Etempvar _r (tptr (Tstruct _secp256k1_uint128 noattr)))
          (Tstruct _secp256k1_uint128 noattr)) _hi tulong)
  ...
  (Sassign
    (Efield
      (Ederef (Etempvar _r (tptr (Tstruct _secp256k1_uint128 noattr)))
        (Tstruct _secp256k1_uint128 noattr)) _lo tulong)
    (Ebinop Omul (Ecast (Etempvar _a tlong) tulong)
      (Ecast (Etempvar _b tlong) tulong) tulong)))
|}.
...
Definition f_secp256k1_i128_accum_mul := {|
  ...
  fn_params := ((_r, (tptr (Tstruct _secp256k1_uint128 noattr))) ::
                (_a, tlong) :: (_b, tlong) :: nil);
  fn_vars := nil;
  fn_temps := ((_lo, tulong) :: (_hi, tulong) :: (_t'3, tint) ::
               (_t'2, tint) :: (_t'1, tlong) :: (_t'12, tulong) ::
               (_t'11, tulong) ::
               (_t'10, (tptr (Tstruct __IO_FILE noattr))) ::
               (_t'9, tulong) :: (_t'8, tulong) ::
               (_t'7, (tptr (Tstruct __IO_FILE noattr))) :: (_t'6, tulong) ::
...
(Ssequence
  ...
  (Ssequence
    (Ssequence
      (Scall (Some _t'1)
        (Evar _secp256k1_mulh (Tfunction (Tcons tlong (Tcons tlong Tnil))
                                tlong cc_default))
        ((Etempvar _a tlong) :: (Etempvar _b tlong) :: nil))
      (Ssequence
        (Sset _t'12
          (Efield
            (Ederef (Etempvar _r (tptr (Tstruct _secp256k1_uint128 noattr)))
              (Tstruct _secp256k1_uint128 noattr)) _lo tulong))
        (Sset _hi
          (Ebinop Oadd (Ecast (Etempvar _t'1 tlong) tulong)
            (Ebinop Olt (Eunop Onotint (Etempvar _lo tulong) tulong)
              (Etempvar _t'12 tulong) tint) tulong))))
    (Ssequence
      (Sloop
        (Ssequence
          (Ssequence
            (Sset _t'11
              (Efield
                (Ederef
                  (Etempvar _r (tptr (Tstruct _secp256k1_uint128 noattr)))
                  (Tstruct _secp256k1_uint128 noattr)) _hi tulong))
            (Sifthenelse (Ebinop Ole (Etempvar _t'11 tulong)
                           (Econst_long (Int64.repr 9223372036854775807) tulong)
                           tint)
              (Sset _t'2
                (Ecast
                  (Ebinop Ole (Etempvar _hi tulong)
                    (Econst_long (Int64.repr 9223372036854775807) tulong)
                    tint) tbool))
                  ...
                  (Ssequence
                    ...
                    (Scall None
                      ...
                      ((Etempvar _t'10 (tptr (Tstruct __IO_FILE noattr))) ::
                       ...
                       (Evar ___stringlit_4 (tarray tschar 122)) :: nil)))
          ...
          (Ssequence
            (Ssequence
              ...
              (Sifthenelse (Ebinop Ogt (Etempvar _t'8 tulong)
                ...
                (Sset _t'3
                  (Ecast
                    (Ebinop Ogt (Etempvar _hi tulong)
                      (Econst_long (Int64.repr 9223372036854775807) tulong)
                      tint) tbool))
                      ...
                      (Scall None
                        (Evar _fprintf (Tfunction
                                         (Tcons
                                           ...
                                           (Tcons (tptr tschar) Tnil)) tint
                                         {|cc_vararg:=(Some 2); cc_unproto:=false; cc_structret:=false|}))
                        ((Etempvar _t'7 (tptr (Tstruct __IO_FILE noattr))) ::
                         (Evar ___stringlit_3 (tarray tschar 11)) ::
                         (Evar ___stringlit_2 (tarray tschar 31)) ::
                         (Econst_int (Int.repr 85) tint) ::
                         (Evar ___stringlit_5 (tarray tschar 119)) :: nil)))
                    (Scall None
            ...
            (Sassign
              (Efield
                (Ederef
                  (Etempvar _r (tptr (Tstruct _secp256k1_uint128 noattr)))
                  (Tstruct _secp256k1_uint128 noattr)) _hi tulong)
              (Ebinop Oadd (Etempvar _t'5 tulong) (Etempvar _hi tulong)
                tulong)))
          (Ssequence
            (Sset _t'4
              (Efield
            ...
            (Sassign
              (Efield
                (Ederef
                  (Etempvar _r (tptr (Tstruct _secp256k1_uint128 noattr)))
                  (Tstruct _secp256k1_uint128 noattr)) _lo tulong)
              (Ebinop Oadd (Etempvar _t'4 tulong) (Etempvar _lo tulong)
                tulong))))))))
|}.
  ...
  (Ssequence
    (Ssequence
      ...
      (Ssequence
        ...
        (Sset _hi
          (Ebinop Oadd (Ecast (Etempvar _t'1 tlong) tulong)
            (Ebinop Olt (Etempvar _t'12 tulong) (Etempvar _lo tulong) tint)
            tulong))))
    (Ssequence
      (Sloop
        (Ssequence
          ...
          (Ssequence
            ...
            (Sifthenelse (Eunop Onotbool
                           (Ebinop Ole (Etempvar _t'2 tint)
                             (Ebinop Ole
                               (Ebinop Osub (Etempvar _t'9 tulong)
                                 (Etempvar _hi tulong) tulong)
                               (Econst_long (Int64.repr 9223372036854775807) tulong)
                               tint) tint) tint)
              (Sloop
                  ...
                  (Ssequence
                    ...
                    (Scall None
                      ...
                      ((Etempvar _t'10 (tptr (Tstruct __IO_FILE noattr))) ::
                       ...
                       (Evar ___stringlit_6 (tarray tschar 121)) :: nil)))
                  (Scall None (Evar _abort (Tfunction Tnil tvoid cc_default))
                    nil))
                Sbreak)
              Sskip)))
          ...
          (Ssequence
            ...
            (Ssequence
              ...
              (Sifthenelse (Eunop Onotbool
                             (Ebinop Ole (Etempvar _t'3 tint)
                               (Ebinop Ogt
                                 (Ebinop Osub (Etempvar _t'6 tulong)
                                   (Etempvar _hi tulong) tulong)
                                 (Econst_long (Int64.repr 9223372036854775807) tulong)
                                 tint) tint) tint)
                (Sloop
                    ...
                    (Ssequence
                      ...
                      (Scall None
                        ...
                        ((Etempvar _t'7 (tptr (Tstruct __IO_FILE noattr))) ::
                         ...
                         (Evar ___stringlit_7 (tarray tschar 120)) :: nil)))
                    (Scall None
                      (Evar _abort (Tfunction Tnil tvoid cc_default)) nil))
                  Sbreak)
                Sskip)))
            ...
            (Sassign
              (Efield
                (Ederef
                  (Etempvar _r (tptr (Tstruct _secp256k1_uint128 noattr)))
                  (Tstruct _secp256k1_uint128 noattr)) _hi tulong)
              (Ebinop Osub (Etempvar _t'5 tulong) (Etempvar _hi tulong)
                tulong)))
          (Ssequence
            (Sset _t'4
              (Efield
...
Definition f_secp256k1_i128_check_bit := {|
  fn_return := tint;
  fn_callconv := cc_default;
  fn_params := ((_r, (tptr (Tstruct _secp256k1_uint128 noattr))) ::
                (_n, tuint) :: nil);
...
((___compcert_va_int32,
 ...
 (_secp256k1_umulh, Gfun(Internal f_secp256k1_umulh)) ::
 (_secp256k1_mulh, Gfun(Internal f_secp256k1_mulh)) ::
 ...
 (_secp256k1_i128_check_bit, Gfun(Internal f_secp256k1_i128_check_bit)) ::
