#if !defined(NO_SHA_NI_FLAG) && defined(__SHA__) && defined(__SSE4_1__) && (defined(__x86_64__) || defined(__amd64__) || defined(__i386__))
#define SHA_NI
#endif
 ...
 */
extern void simplicity_cpu_optimize_not_thread_safe(void) __attribute__((constructor));
extern void simplicity_cpu_optimize_not_thread_safe(void) {
#ifdef SHA_NI
  if (cpu_has_sha_ni()) {
