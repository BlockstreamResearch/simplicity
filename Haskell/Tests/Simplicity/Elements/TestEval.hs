-- | This module builds a wrapper around 'Simplicity.Elements.Semantics.fastEval' to define a 'testEval' variant.
module Simplicity.Elements.TestEval
  ( testEval, TestEval
  ) where
...
import qualified Simplicity.Elements.Jets as Jets
import Simplicity.Elements.JetType
