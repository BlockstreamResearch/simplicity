...
WRAP_(internal_key)
WRAP_(annex_hash)
WRAP_(inputs_hash_deprecated)
WRAP_(outputs_hash_deprecated)
WRAP_(num_inputs)
WRAP_(num_outputs)
WRAP_(tx_is_final)
...
WRAP_(output_asset_amounts_hash)
...
WRAP_(input_asset_amounts_hash)
