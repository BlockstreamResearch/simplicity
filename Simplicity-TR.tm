...
<\body>
  ...
  <\eqnarray*>
    <tformat|<table|<row|<cell|<around*|(|Confidential<around*|(|f|)><around*|(|a|)>|)><around*|[|pt|]>>|<cell|\<assign\>>|<cell|<around*|(|a|)><around*|[|pt|]>>>|<row|<cell|<around*|(|Confidential<around*|(|f|)><around*|(|a|)>|)><around*|[|prf|]>>|<cell|\<assign\>>|<cell|f<around*|(|<around*|(|a|)><around*|[|prf|]>|)>>>|<row|<cell|Asset<around*|(|f|)><around*|(|<injl|<around*|(|a|)>>|)>>|<cell|\<assign\>>|<cell|<injl|<around*|(|Confidential<around*|(|f|)><around*|(|a|)>|)>>>>|<row|<cell|Asset<around*|(|f|)><around*|(|<injr|<around*|(|a|)>>|)>>|<cell|\<assign\>>|<cell|<injr|<around*|(|a|)>>>>|<row|<cell|Amount<around*|(|f|)><around*|(|<injl|<around*|(|a|)>>|)>>|<cell|\<assign\>>|<cell|<injl|<around*|(|Confidential<around*|(|f|)><around*|(|a|)>|)>>>>|<row|<cell|Amount<around*|(|f|)><around*|(|<injr|<around*|(|a|)>>|)>>|<cell|\<assign\>>|<cell|<injr|<around*|(|a|)>>>>|<row|<cell|ClearAsset<around*|(|a|)>>|<cell|\<assign\>>|<cell|Asset<around*|(|<math-ss|unit>|)><around*|(|a|)>>>|<row|<cell|ClearAmount<around*|(|a|)>>|<cell|\<assign\>>|<cell|Amount<around*|(|<math-ss|unit>|)><around*|(|a|)>>>>>
  </eqnarray*>
