...
POST [ tint ]
  PROP()
  RETURN(Vint (Int.repr (Z.b2z (secp256k1_uint128.z r mod 2^128 =? secp256k1_uint128.z s mod 2^128))))
  SEP(iter_sepcon secp256k1_uint128.at_args ptrs).
...
Lemma body_secp256k1_u128_load_spec: semax_body Vprog Gprog f_secp256k1_u128_load secp256k1_u128_load_spec.
Proof.
start_function.
repeat forward.
entailer!.
...
Lemma body_secp256k1_i128_load_spec: semax_body Vprog Gprog f_secp256k1_i128_load secp256k1_i128_load_spec.
Proof.
start_function.
repeat forward.
entailer!.
...
forward_verify_check.
 ...
 convert_C_to_math.
 cbn.
 intros H2; apply typed_true_of_bool in H2; revert H2.
 case Z.ltb_spec;[discriminate|lia].
forward_verify_check.
