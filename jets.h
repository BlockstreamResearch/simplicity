...
bool xor3_8(frameItem* dst, frameItem src, const txEnv* env);
bool xor3_16(frameItem* dst, frameItem src, const txEnv* env);
bool xor3_32(frameItem* dst, frameItem src, const txEnv* env);
bool xor3_64(frameItem* dst, frameItem src, const txEnv* env);
